    ...
    <div class="px-4 sm:px-0">
        ...
        <div class="mt-6 space-y-4">
            ...
            <div class="grid sm:grid-cols-2 sm:gap-8">
                ...
                <div>
                    <a href="{{ route('chat.index') }}" class="flex space-x-2 items-center px-4 py-2 rounded-b-lg sm:rounded-lg bg-gray-300 sm:space-x-0 sm:flex-col sm:space-y-4 sm:justify-center sm:px-4 sm:py-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 sm:w-16 sm:h-16">
