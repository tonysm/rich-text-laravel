<form action="{{ route('messages.store') }}" method="post" class="group" data-controller="composer">
    ...
    <div class="flex text-lg items-center justify-between rounded-3xl border px-1 border-gray-400 bg-white focus-within:border-transparent focus-within:ring-4 group-data-[composer-show-toolbar-value=true]:rounded-lg group-data-[composer-show-toolbar-value=true]:items-end">
