...
- Rendering for end users (@verbatim`{!! $post->body !!}` @endverbatim) differs from rendering for editors (`$post->body->toEditorHtml()`).
...
- IMPORTANT: When rendering rich text in Blade, use @verbatim`{!! $post->body !!}`@endverbatim (unescaped) but always sanitize first.
